...
<Steps>
  ...
  <Step>**Chain fixes** — if the score drops, check what new audit finding appeared. The chain continues until no new findings are introduced and scores improve</Step>
</Steps>
