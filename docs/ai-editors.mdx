...
description: A must-have tool for agentic coding — teach your AI assistant structural discipline
icon: Bot
---
...
- **Per-audit resolution guidance** — what each of the 14 audits detects and how to fix it
