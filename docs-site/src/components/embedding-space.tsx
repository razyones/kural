...
export function EmbeddingSpace() {
  ...
  const onSliderPointerDown = useCallback((e: React.PointerEvent<HTMLDivElement>) => {
    ...
    setRotation(Math.round(pct * 360));
  }, []);
  ...
  return (
    <div className="h-full w-full select-none">
      <div className="relative w-full h-full">
        {/* Breadcrumbs */}
        <div className="absolute top-0 inset-x-0 z-20 flex items-center gap-2 px-4 py-2.5 text-[13px] tracking-wider backdrop-blur-md bg-fd-background/60 border-b border-fd-border/20">
          <svg
            viewBox="0 0 20 20"
            width={20}
            height={20}
          ...
          {hoveredPoint &&
            ...
            (() => {
              ...
              return (
                ...
                >
                  <div className="bg-fd-card/80 backdrop-blur-md border border-fd-border/50 px-3 py-2 w-[220px] relative shadow-lg">
                    <button
                      onClick={() => {
                        setCardHidden(true);
                      }}
        ...
        {/* Rotation slider */}
        <div className="absolute left-3 top-1/2 -translate-y-1/2 z-20 flex flex-col items-center gap-1.5 py-3 px-2 rounded-full backdrop-blur-md bg-fd-background/50 border border-fd-border/40 shadow-sm">
          <span className="text-[9px] text-fd-muted-foreground/70 tabular-nums select-none w-[26px] text-center">
            {normalizedRotation}°
          </span>
          <div
            className="relative w-1 h-24 rounded-full bg-fd-muted-foreground/20 cursor-pointer touch-none"
        ...
        <div className="absolute bottom-3 left-3 z-20">
          <a
            ...
            className="flex flex-col px-2.5 py-1.5 rounded-xl border border-fd-border/40 backdrop-blur-md bg-fd-background/50 text-fd-foreground cursor-pointer max-w-full shadow-sm"
          >
            <span className="flex items-center gap-1.5 text-[12px] pb-1.5">
              <svg
                viewBox="0 0 16 16"
                width={13}
                height={13}
              ...
              <span className="font-semibold">razyones/kural</span>
              <span className="text-fd-muted-foreground">visualized</span>
            </span>
            <hr className="border-fd-border" />
            <span className="text-[10px] text-fd-muted-foreground pt-1">
              3,072 dimensional embeddings projected to 3D via PCA
            </span>
          </a>
        </div>
      </div>
