...
function Home() {
  return (
    <HomeLayout nav={{ title: config.name }}>
      <div className="flex flex-1 min-h-0 max-h-[calc(100vh-var(--fd-nav-height,56px))] overflow-hidden">
        ...
        <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24">
          <p
            className="text-[11px] uppercase tracking-[0.08em] mb-6"
            style={{ color: "hsl(187, 40%, 55%)" }}
          >
            Structural scoring for TypeScript
          </p>
          <h1
            className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-tighter text-fd-foreground mb-4 leading-[1.05]"
            style={{ fontFamily: '"Lexend Peta", sans-serif' }}
          >
            KURAL
          </h1>
          <p className="text-fd-muted-foreground text-base md:text-lg max-w-md mb-10 font-light leading-relaxed">
